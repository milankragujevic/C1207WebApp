...
<head>
    <meta charset="utf-8" />
    <title>@yield('title','Undefinded Title')</title>
    ...
    <div class="page-sidebar-wrapper">
        ...
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                ...
                <li class="heading">
                    <h3 class="uppercase">Movie Manager</h3>
                </li>
                <li class="nav-item {{ Request::is('admin/movie/*')? 'active open':'' }} " >
                    ...
                    <ul class="sub-menu" >
                        <li class="nav-item {{ Request::is('admin/movie/newmovie')? 'active open':'' }} ">
                            <a href="{{ url('/admin/movie/newmovie') }}" class="nav-link ">
                                <span class="title">Add Movie</span>
                            </a>
                        </li>
                        <li class="nav-item  ">
                    ...
                    <ul class="sub-menu">
                        <li class="nav-item  ">
                            <a href="ui_colors.html" class="nav-link ">
                                <span class="title">Add Director</span>
                            </a>
                        </li>
                        <li class="nav-item  ">
                            <a href="ui_general.html" class="nav-link ">
                                <span class="title">Director List</span>
                            </a>
                        </li>
                        <li class="nav-item  ">
                            <a href="ui_buttons.html" class="nav-link ">
